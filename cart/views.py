...
def cart_detail(request,total=0,counter=0,cart_items=None):
        ...
        try:
            ...
            try:
                ...
                for order_item in cart_items:
                    ...
                    oi.save()
                    #reduceTheStockWhenOrderIsPlaced
                    products=Products.objects.get(id=order_item.product.id)
                    products.stock= int(order_item.product.stock - order_item.quantity)
                    products.save()
                    order_item.delete()
                    #Theterminal will print this mesage when order is saved
    ...
    return render(request,'cart.html',dict(cart_items=cart_items,total=total,counter=counter,stripe=stripe,data_key=data_key,description=description))
